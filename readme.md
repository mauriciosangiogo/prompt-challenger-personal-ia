...
Além das variáveis prepostas, adicionei ainda as variáveis:
1 - Local - Essa regra informa a preferência do local de treino.
2 - Tempo - Essa regra informa o tempo disponível para treino.
3 - Experiência - Essa regra informa qual o nível de experiência do cliente.
4 - Objetivo - Essa regra indforma qual o objetivo do cliente com esse treino.
...
Com base nos valores informados na área de variáveis e com as guidelines, crie um treino pessoal que corresponde a combinação desses 7 valores.
